  ...
  return (
    <main>
      <section className="max-w-[1400px] mx-auto px-4 md:px-8 pt-10 md:pt-16 pb-16 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(320px,460px)] items-center min-h-[calc(100dvh-4rem)]">
        <div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.05] max-w-[16ch]">
      ...
      <section className="max-w-[1400px] mx-auto px-4 md:px-8 pb-24">
        <h2 className="text-3xl font-semibold tracking-tight mb-8">Twelve pieces, one pencil</h2>
      ...
      <section className="max-w-[1400px] mx-auto px-4 md:px-8 pb-24">
        <h2 className="text-3xl md:text-4xl font-semibold tracking-tight leading-tight max-w-[20ch]">
