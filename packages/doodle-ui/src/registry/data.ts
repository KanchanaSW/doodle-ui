...
export const REGISTRY_DATA: Registry = {
  ...
  "sharedFiles": [
    {
      "name": "animations/DoodleUIProvider.tsx",
      "path": "animations/DoodleUIProvider.tsx",
      "dependencies": [],
    ...
    {
      "name": "animations/useDrawIn.ts",
      "path": "animations/useDrawIn.ts",
      "dependencies": [],
    ...
    {
      "name": "animations/usePrefersReducedMotion.ts",
      "path": "animations/usePrefersReducedMotion.ts",
      "dependencies": [],
      "content": "\"use client\";\n\nimport { useSyncExternalStore } from \"react\";\n\nfunction subscribe(onStoreChange: () => void) {\n  const media = window.matchMedia(\"(prefers-reduced-motion: reduce)\");\n  media.addEventListener(\"change\", onStoreChange);\n  return () => media.removeEventListener(\"change\", onStoreChange);\n}\n\nfunction getSnapshot() {\n  return window.matchMedia(\"(prefers-reduced-motion: reduce)\").matches;\n}\n\nfunction getServerSnapshot() {\n  return false;\n}\n\nexport function usePrefersReducedMotion(): boolean {\n  return useSyncExternalStore(subscribe, getSnapshot, getServerSnapshot);\n}\n"
    },
    {
      "name": "animations/useTweenNumber.ts",
      "path": "animations/useTweenNumber.ts",
      "dependencies": [],
    ...
    {
      "name": "context/SketchSeedContext.tsx",
      "path": "context/SketchSeedContext.tsx",
      "dependencies": [],
    ...
    {
      "name": "hooks/useElementSize.ts",
      "path": "hooks/useElementSize.ts",
      "dependencies": [],
    ...
    {
      "name": "hooks/useIsomorphicLayoutEffect.ts",
    ...
    {
      "name": "hooks/useResolvedSeed.ts",
      "path": "hooks/useResolvedSeed.ts",
      "dependencies": [],
    ...
    {
      "name": "hooks/useSketchSeed.ts",
      "path": "hooks/useSketchSeed.ts",
      "dependencies": [],
      "content": "\"use client\";\n\nexport {\n  SketchSeedProvider,\n  useSketchSeed,\n  useOptionalSketchSeed,\n  type SketchSeedContextValue,\n  type SketchSeedProviderProps,\n} from \"../context/SketchSeedContext\";\n"
    },
    {
      "name": "hooks/useSketchTheme.ts",
      "path": "hooks/useSketchTheme.ts",
      "dependencies": [],
    ...
    {
      "name": "primitives/RoughSvg.tsx",
      "path": "primitives/RoughSvg.tsx",
      "dependencies": [
        "roughjs"
      ],
    ...
    {
      "name": "primitives/SketchBox.tsx",
      "path": "primitives/SketchBox.tsx",
      "dependencies": [
        "@radix-ui/react-slot"
      ],
    ...
    {
      "name": "primitives/SlidingPanel.tsx",
      "path": "primitives/SlidingPanel.tsx",
      "dependencies": [
  ...
  "components": {
    "accordion": {
      ...
      "description": "Radix accordion with sketch dividers between items and a hand-drawn chevron that rotates on expand.",
      "category": "layout",
      "isRadix": true,
      ...
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Play sketch draw-in animations. Defaults to DoodleUIProvider animate (true)."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "alert": {
      "name": "alert",
      "displayName": "Alert",
      "description": "Callout with a color-coded stroke: info, warning, error, success. Body copy stays ink-colored so it stays readable. The frame draws in quickly (~200ms) so dynamic alerts still feel sketched.",
      "category": "feedback",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
      "props": [
        ...
        },
        {
          ...
          "type": "ReactNode",
          "required": false,
          "description": "Leading icon beside the title/body."
        },
        {
          "name": "strokeWidth",
          "type": "number",
      ...
      "example": "<Alert variant=\"warning\" title=\"Heads up\" startIcon={<Icon />}>\n  Check your settings.\n</Alert>",
      "keywords": [
        "callout",
        "banner",
        "status",
    ...
    "alert-dialog": {
      ...
      "description": "The confirm / destructive-action variant of `Dialog`, built on Radix Alert Dialog. Unlike `Dialog`, there is no dismiss-on-outside-click or Escape by default — the user must pick an action.",
      "category": "overlay",
      "isRadix": true,
      ...
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Backdrop fade, panel enter/exit, and border draw-in on open.\nDefaults to the DoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "aspect-ratio": {
      ...
      "description": "Keeps media at a fixed width-to-height ratio. Optionally wrap content in a sketch frame.",
      "category": "layout",
      "isRadix": true,
      ...
      "props": [
        ...
        },
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Wrap content in a hand-drawn frame. Default false — ratio box only."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "avatar": {
      "name": "avatar",
      "displayName": "Avatar",
      "description": "Radix avatar with a sketch circular or square frame. Falls back to initials, with an optional status dot.",
      ...
      "props": [
        ...
        {
          "name": "size",
          "type": "DoodleSize | number",
          "required": false,
          "defaultValue": "\"md\"",
          "description": "Avatar size preset or exact pixel dimension."
        },
        {
          "name": "sketchColor",
          "type": "string",
    ...
    "badge": {
      "name": "badge",
      "displayName": "Badge",
      "description": "Compact label with a sketch rectangle. Use it for status, counts, or a one-word tag. The border draws in on mount.",
      "category": "data-display",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
      "props": [
        ...
        },
        {
          ...
          "required": false,
          "defaultValue": "false",
          "description": "Merge props onto the single child instead of rendering a wrapper span."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "breadcrumb": {
      ...
      "description": "A nav trail with hand-drawn slash or chevron separators between crumbs.",
      "category": "navigation",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
    ...
    "button": {
      ...
      "props": [
        ...
        },
        {
          ...
          "required": false,
          "defaultValue": "false",
          "description": "Show a sketchy spinner and disable interaction."
        },
        {
          "name": "roughness",
          "type": "number",
        ...
        },
        {
          ...
          "type": "ReactNode",
          "required": false,
          "description": "Leading icon (any ReactNode — lucide, SVG, emoji, etc.)."
        },
        {
          "name": "strokeWidth",
          "type": "number",
    ...
    "card": {
      "name": "card",
      "displayName": "Card",
      "description": "Container with a sketch border. Optional offset rectangle behind it reads as a paper shadow. The border draws in on mount.",
      "category": "layout",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
      ...
      "props": [
        ...
        },
        {
          ...
          "required": false,
          "defaultValue": "false",
          "description": "Merge props onto the single child instead of rendering a `<div>`."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "carousel": {
      ...
      "description": "Embla-powered slides with circular sketch arrows outside the viewport, matching the usual carousel layout.",
      "category": "data-display",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
      ...
      "example": "const { api, scrollNext } = useCarousel();",
      "keywords": [
        "slider",
        "slides",
        "gallery",
    ...
    "checkbox": {
      ...
      "description": "Radix checkbox with a sketch square. The checkmark is a rough.js path, not a font glyph. The box draws in on mount; the checkmark path draws in when checked.",
      "category": "form",
      "isRadix": true,
      ...
      "example": "<Checkbox label=\"Accept\" name=\"terms\" required />",
      "keywords": [
        "check",
        "toggle",
        "boolean",
    ...
    "collapsible": {
      ...
      "description": "A single expand/collapse section — the simpler primitive behind `Accordion`. The chevron rotates open with the same hand-drawn path.",
      "category": "layout",
      "isRadix": true,
    ...
    "combobox": {
      ...
      "description": "A searchable select. Radix has no dedicated Combobox primitive, so this composes `Popover` (positioning) and `Command` (search/filter) behind a sketchy, `Select`-styled trigger — the same recipe shadcn uses.",
      "category": "form",
      "isRadix": true,
      ...
      "props": [
        ...
        },
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in the trigger on mount and the popover border on open.\nDefaults to the DoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
      ...
      "example": "import { Combobox } from \"doodleui-react\";\n\n<Combobox\n  options={[\n    { value: \"pen\", label: \"Pen\" },\n    { value: \"pencil\", label: \"Pencil\" },\n    { value: \"brush\", label: \"Brush\" },\n  ]}\n  placeholder=\"Select a tool…\"\n/>",
      "keywords": [
        "searchable",
        "select",
        "autocomplete",
    ...
    "command": {
      "name": "command",
      "displayName": "Command",
      "description": "A command palette / cmd+k style searchable list, powered by [cmdk](https://cmdk.paco.me) inside a sketch-bordered panel.",
      "category": "overlay",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
      ...
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in the panel border on mount.\nDefaults to the DoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "context-menu": {
      ...
      "description": "Right-click menu with sketch panel and dividers.",
      "category": "overlay",
      "isRadix": true,
      ...
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in the panel border when the menu opens.\nDefaults to the DoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "dialog": {
      "name": "dialog",
      "displayName": "Dialog",
      "description": "A lighter, fully composable sibling to `Modal`. `Modal` is a single-prop, fixed-width, always-shadowed dialog with a forced close button. `Dialog` is the shadcn-style compound API — no forced width or shadow, and you build the header/footer yourself.",
      "category": "overlay",
      "isRadix": true,
    ...
    "divider": {
      "name": "divider",
      "displayName": "Divider",
      "description": "A squiggly rule. Horizontal fills the width. Vertical fills the height. On mount the stroke extends across its length.",
      "category": "layout",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in so the line extends across its length. Defaults to the\nDoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "drawer": {
      "name": "drawer",
      "displayName": "Drawer",
      "description": "Bottom drawer with sketch pull handle.",
      "category": "overlay",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
    ...
    "dropdown-menu": {
      ...
      "description": "A sketchy-bordered menu panel with hand-drawn item separators, built on Radix Dropdown Menu. Includes items, checkbox items, radio items, labels, and separators.",
      "category": "overlay",
      "isRadix": true,
    ...
    "empty": {
      "name": "empty",
      "displayName": "Empty",
      "description": "Composable empty-state layout: media, title, description, and optional actions.",
      "category": "feedback",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
    ...
    "hover-card": {
      ...
      "description": "Popover-like card that opens on hover.",
      "category": "overlay",
      "isRadix": true,
    ...
    "input": {
      "name": "input",
      "displayName": "Input",
      "description": "Single-line text field with a sketchy border. Native focus rings are removed. Focus re-inks the border with a second seed (and still shifts the stroke toward the accent color).",
      "category": "form",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
      "props": [
        ...
        },
        {
          ...
          "type": "ReactNode",
          "required": false,
          "description": "Trailing icon inside the field."
        },
        {
          "name": "fillStyle",
          "type": "FillStyle",
    ...
    "input-group": {
      ...
      "description": "One sketch frame wrapping an input and addons.",
      "category": "form",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
    ...
    "input-otp": {
      ...
      "description": "Segmented PIN input with sketch slots.",
      "category": "form",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
    ...
    "kbd": {
      "name": "kbd",
      "displayName": "Kbd",
      "description": "Inline keyboard hint with a hand-drawn border.",
      "category": "data-display",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in the border on mount. Defaults to the DoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "label": {
      "name": "label",
      "displayName": "Label",
      "description": "A thin, mostly-typographic wrapper around Radix Label. Ties a caption to a form field via `htmlFor`. The only sketch chrome is a small hand-drawn dot after the text when `required` is set.",
      "category": "form",
      "isRadix": true,
      ...
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in the required mark on mount.\nDefaults to the DoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
        ...
        },
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Adds a small hand-drawn required mark after the text."
        },
        {
          "name": "roughness",
          "type": "number",
      ...
      "example": "import { Label, Input } from \"doodleui-react\";\n\n<Label htmlFor=\"email\" required>\n  Email\n</Label>\n<Input id=\"email\" placeholder=\"you@studio.dev\" />",
      "keywords": [
        "caption",
        "form",
        "accessibility"
    ...
    "menubar": {
      "name": "menubar",
      "displayName": "Menubar",
      "description": "Desktop-style menu bar (File, Edit, View).",
      "category": "navigation",
      "isRadix": true,
    ...
    "modal": {
      "name": "modal",
      "displayName": "Modal",
      "description": "Radix Dialog with a sketch frame and a dimmed backdrop. Focus trap, Escape to close, and ARIA labelling are inherited. Opening fades the backdrop, eases the panel in, and draws the frame.",
      "category": "overlay",
      "isRadix": true,
      "radixPrimitive": "@radix-ui/react-dialog",
      "subparts": [
    ...
    "native-select": {
      ...
      "description": "A native `<select>` with a sketch border and hand-drawn chevron — no custom popover.",
      "category": "form",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in the border on mount. Defaults to DoodleUIProvider (true)."
        },
        {
          "name": "bowing",
          "type": "number",
      ...
      "files": [
        {
          ...
          "path": "components/native-select.tsx",
          "type": "component",
    ...
    "navigation-menu": {
      ...
      "description": "Horizontal navigation with sketch dropdown panels.",
      "category": "navigation",
      "isRadix": true,
    ...
    "pagination": {
      ...
      "description": "Sketch-circled page buttons with a heavier active ring. Prev/next use hand-drawn arrows.",
      "category": "navigation",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
    ...
    "popover": {
      "name": "popover",
      "displayName": "Popover",
      "description": "A sketchy-bordered floating panel anchored to a trigger, built on Radix Popover. The panel border draws in on open, same recipe as the Select menu.",
      "category": "overlay",
      "isRadix": true,
      "radixPrimitive": "@radix-ui/react-popover",
      "subparts": [
      ...
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in the panel border when the popover opens.\nDefaults to the DoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "progress": {
      ...
      "description": "Outer sketch bar plus an inner fill drawn with slightly higher roughness, so it looks hand-filled. The track draws in on mount. Changing `value` animates the fill width and redraws the hatch a little rougher as it fills.",
      "category": "feedback",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in the track on mount and redraw the fill as value changes.\nDefaults to the DoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "radial-menu": {
      ...
      "description": "Plus trigger fans sketch actions in an arc.",
      "category": "navigation",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
      ...
      "files": [
        {
          "name": "radial-menu.tsx",
          "path": "components/radial-menu.tsx",
          "type": "component",
    ...
    "radial-progress": {
      ...
      "description": "Radial tick-gauge progress and loading indicator with a traveling height wave.",
      "category": "feedback",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
      "props": [
        {
          ...
          "type": "string",
          "required": false,
          "description": "Active tick color. Defaults to theme success green."
        },
        {
          "name": "animate",
          "type": "boolean",
          "required": false,
          "defaultValue": "undefined (follow provider)",
          "description": "Play wave animations. Defaults to  `animate` (true)."
        },
        {
          "name": "bowing",
          "type": "number",
        ...
        },
        {
          ...
          "required": false,
          "description": "Custom formatter for center text when `children` is omitted."
        },
        {
          "name": "hachureAngle",
          "type": "number",
        ...
        },
        {
          ...
          "required": false,
          "defaultValue": "true",
          "description": "Whether to display the center value / children."
        },
        {
          "name": "size",
          "type": "RadialProgressSize | number",
          "required": false,
          "defaultValue": "\"md\"",
          "description": "Overall diameter size preset or custom pixel number."
        },
        {
          "name": "sketchColor",
          "type": "string",
        ...
        },
        {
          ...
          "required": false,
          "defaultValue": "270",
          "description": "Sweep angle in degrees of the open arc."
        },
        {
          "name": "tickCount",
          "type": "number",
          "required": false,
          "defaultValue": "48",
          "description": "Total number of radial tick bars along the arc."
        },
        {
          "name": "trackColor",
          "type": "string",
          "required": false,
          "description": "Inactive tick color. Defaults to muted track ink."
        },
        {
          "name": "value",
          "type": "number",
        ...
        },
        {
          ...
          "required": false,
          "defaultValue": "2",
          "description": "Wave animation speed in seconds per full cycle."
        }
      ],
      "example": "<RadialProgress value={75} />\n<RadialProgress />",
      "keywords": [
        "circular",
        "gauge",
        "loader",
      ...
      "files": [
        {
          "name": "radial-progress.tsx",
          "path": "components/radial-progress.tsx",
          "type": "component",
    ...
    "radio": {
      "name": "radio",
      "displayName": "Radio",
      "description": "Sketch circle with a solid inner dot when selected. Must live inside `RadioGroup`. The ring draws in on mount; the dot scales and draws in on select.",
      "category": "form",
      "isRadix": true,
      ...
      "example": "<RadioGroup name=\"plan\" defaultValue=\"pro\">\n  <Radio value=\"pro\" label=\"Pro\" />\n</RadioGroup>",
      "keywords": [
        "radio",
        "choice",
        "option",
    ...
    "resizable": {
      ...
      "description": "Drag to resize panels; sketch handle on the divider.",
      "category": "layout",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
      ...
      "example": "import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from \"doodleui-react\";\n\n<ResizablePanelGroup direction=\"horizontal\">\\n  <ResizablePanel defaultSize={50} />\\n  <ResizableHandle />\\n  <ResizablePanel defaultSize={50} />\\n</ResizablePanelGroup>",
      "keywords": [
        "panels",
        "drag",
        "split",
    ...
    "scroll-area": {
      ...
      "description": "Scrollable region with sketch border and rough scrollbar.",
      "category": "layout",
      "isRadix": true,
    ...
    "select": {
      "name": "select",
      "displayName": "Select",
      "description": "Radix select with a sketch trigger and a framed popover. Highlighted and selected items get a hand-drawn underline. The trigger draws in on mount; the menu frame draws in when it opens.",
      "category": "form",
      "isRadix": true,
    ...
    "sheet": {
      "name": "sheet",
      "displayName": "Sheet",
      "description": "Edge-anchored slide-out panel (default: right).",
      "category": "overlay",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
    ...
    "sidebar": {
      "name": "sidebar",
      "displayName": "Sidebar",
      "description": "Collapsible app sidebar with sketch divider and toggle. Compose with `SidebarLayout` and `SidebarInset`.",
      "category": "navigation",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
      ...
      "example": "const { collapsed, toggleCollapsed } = useSidebar();",
      "keywords": [
        "nav",
        "app",
        "layout",
    ...
    "skeleton": {
      ...
      "description": "A scribble-fill placeholder. Pulse reseeds the hatch on an interval so the doodle redraws instead of shimmering.",
      "category": "feedback",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
    ...
    "slider": {
      "name": "slider",
      "displayName": "Slider",
      "description": "Radix slider with a wobbly track line and a sketch thumb. The filled range is a second, rougher stroke.",
      "category": "form",
      "isRadix": true,
    ...
    "spinner": {
      "name": "spinner",
      "displayName": "Spinner",
      "description": "Rotating sketch arc for loading states.",
      "category": "feedback",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Continuous rotation. Defaults to the DoodleUIProvider value (true).\nReduced motion shows a static arc."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "stepper": {
      "name": "stepper",
      "displayName": "Stepper",
      "description": "Numbered sketch circles joined by hand-drawn connectors. Completed steps fill in; the current step keeps a heavier ring.",
      "category": "navigation",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
    ...
    "switch": {
      "name": "switch",
      "displayName": "Switch",
      "description": "Radix switch with a sketch pill track and a circular thumb that slides. Toggling springs the thumb and re-inks the track with a second seed.",
      "category": "form",
      "isRadix": true,
      ...
      "example": "<Switch label=\"Notifications\" name=\"notify\" />",
      "keywords": [
        "toggle",
        "on",
        "off",
    ...
    "table": {
      "name": "table",
      "displayName": "Table",
      "description": "A real HTML table with hand-drawn row dividers instead of CSS borders. Optional heavier underline under the header. Rules draw in on mount, staggered a little row by row.",
      "category": "data-display",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [
      ...
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in row rules on mount, staggered slightly. Defaults to the\nDoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "tabs": {
      "name": "tabs",
      "displayName": "Tabs",
      "description": "Radix tabs with a sketch underline under the active trigger. Switching tabs slides the rule and redraws it with a derived seed.",
      "category": "navigation",
      "isRadix": true,
      ...
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in the active underline and slide it on tab change.\nDefaults to the DoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "textarea": {
      ...
      "description": "Same treatment as Input, sized for longer notes. The sketch rectangle resizes with the element. Focus re-inks the border with a second seed.",
      "category": "form",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
      ...
      "example": "<Textarea label=\"Notes\" name=\"notes\" />",
      "keywords": [
        "multiline",
        "text",
        "notes",
    ...
    "toast": {
      "name": "toast",
      "displayName": "Toast",
      "description": "Radix toast with Alert-like sketch chrome. Wrap the tree in `ToastProvider` for stacking, auto-dismiss, and the live region.",
      "category": "feedback",
      "isRadix": true,
      ...
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Slide-in with a sketchy settle wobble, reversed on exit.\nDefaults to the DoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
        ...
        },
        {
          ...
          "required": false,
          "defaultValue": "\"md\"",
          "description": "Toast density preset."
        },
        {
          "name": "sketchColor",
          "type": "string",
        ...
        {
          "name": "swipeDirection",
          "type": "ToastPrimitive.ToastProviderProps[\"swipeDirection\"]",
          "required": false,
          "description": ""
        },
        {
    ...
    "toggle": {
      "name": "toggle",
      "displayName": "Toggle",
      "description": "Single on/off control with sketch fill when pressed.",
      "category": "form",
      "isRadix": true,
      ...
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Draw-in on mount and seed morph on press.\nDefaults to the DoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
    ...
    "toggle-group": {
      ...
      "description": "Grouped toggles with single or multiple selection.",
      "category": "form",
      "isRadix": true,
    ...
    "tooltip": {
      "name": "tooltip",
      "displayName": "Tooltip",
      "description": "Radix Tooltip with a small sketch bubble. Wrap the app in `TooltipProvider` once (the docs site already does). The bubble draws in quickly when it shows.",
      "category": "overlay",
      "isRadix": true,
      ...
      "props": [
        {
          ...
          "type": "boolean",
          "required": false,
          "description": "Quick draw-in when the bubble shows (~180ms). Defaults to the\nDoodleUIProvider value (true)."
        },
        {
          "name": "bowing",
          "type": "number",
        ...
        {
          "name": "side",
          "type": "ComponentPropsWithoutRef<typeof TooltipPrimitive.Content>[\"side\"]",
          "required": false,
          "description": ""
        },
        {
    ...
    "typography": {
      ...
      "description": "Preset text components with optional hand-drawn underlines, highlights, and rules.",
      "category": "data-display",
      "isRadix": false,
      "radixPrimitive": null,
      "subparts": [],
